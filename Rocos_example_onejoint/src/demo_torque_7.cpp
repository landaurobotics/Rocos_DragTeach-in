...
bool isRuning = true;
std::ofstream outputFile("/home/landau/Rocos_example/src/joint_torques_7dof.csv");
...
#pragma region              // RNE dynamics
        int _joint_num = 7; /* Your joint number */

        std::string urdf_file = "/home/landau/Rocos_example/config/robot_sun_new.urdf";
